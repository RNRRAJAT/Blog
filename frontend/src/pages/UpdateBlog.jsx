...
const UpdateBlog = () => {
  ...
  const updateBlogHandler = async ()=>{
    ...
    try {
      ...
      const res = await axios.put(`https://blog-fxgk.onrender.com/blog/${id}`,formData,{
        headers:{
  ...
  const togglePublishUnpublish = async()=>{
    try {
      const res = await axios.patch(`https://blog-fxgk.onrender.com/blog/${id}`,{
        // params:{
        //   action
        // },
        withCredentials:true
  ...
  const deleteBlog = async(id)=>{
    try {
      const res = await axios.delete(`https://blog-fxgk.onrender.com/delete/${id}`,{withCredentials:true})
      if(res.data.success){
