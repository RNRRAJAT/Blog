...
const TotalProperty = () => {
    ...
    const getOwnBlog = async()=>{
        try {
            const res = await axios.get(`https://blog-fxgk.onrender.com/blog/get-own-blogs`,{withCredentials:true})
            if(res.data.success){
    ...
    const getTotalComments = async()=>{
        try {
            const res = await axios.get(`https://blog-fxgk.onrender.com/comment/my-blogs/comments`,{withCredentials:true})
            if(res.data.success){
    ...
    const getTotalLikes = async()=>{
        try {
            const res = await axios.get(`https://blog-fxgk.onrender.com/blog/my-blogs/likes`,{withCredentials:true})
            if(res.data.success){
